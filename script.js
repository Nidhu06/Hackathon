    ...
    fetch(`https://api.github.com/users/${user_name}`)
        ...
        .then(function (data) {
            ...
            if (data.message === "Not Found") {
                ...
                user_img.innerHTML = `<a target="_blank" title="Click to view user github" href="https://www.github.com/${user_name}"><img src="${data.avatar_url}"></a>`;
        ...
        .then(function (repo_data) {
            ...
            if (repo_data.length <= 0) {
                ...
                if (repo_data.message === "Not Found") {
                    ...
                    `
                    user_img.innerHTML = `<img src="gitlogo.png">`;
                    userName.innerHTML = ``;
                    ...
                    repo_details.innerHTML = repo_Data;
